...
- [1. Cookie](#1-cookie)
  ...
  - [1.2. Cookie 的工作步骤](#12-cookie-的工作步骤)
  - [1.3. Cookie 的作用](#13-cookie-的作用)
  - [1.4. Cookie 的重要属性](#14-cookie-的重要属性)
- [2. Session](#2-session)
  - [2.1. 什么是 Session](#21-什么是-session)
  - [2.2. Session 的工作步骤](#22-session-的工作步骤)
- [3. Cookie 和 Session 的区别](#3-cookie-和-session-的区别)
- [4. 如果禁用 Cookie 怎么办](#4-如果禁用-cookie-怎么办)
- [5. 分布式 Session](#5-分布式-session)
  - [5.1. 粘性 Session](#51-粘性-session)
  - [5.2. Session 复制共享](#52-session-复制共享)
  - [5.3. 基于缓存的 session 共享](#53-基于缓存的-session-共享)
- [6. 具体实现](#6-具体实现)
  - [6.1. JWT Token](#61-jwt-token)
  - [6.2. tomcat + redis](#62-tomcat--redis)
  - [6.3. spring session + redis](#63-spring-session--redis)
- [7. 参考资料](#7-参考资料)
