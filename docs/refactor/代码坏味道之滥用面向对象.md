...
![](http://dunwu.test.upcdn.net/cs/design/refactor/switch-statements-1.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/switch-statements-2.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/temporary-field-1.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/temporary-field-2.png)

### 收益

- 更好的代码清晰度和组织性。

![](http://dunwu.test.upcdn.net/cs/design/refactor/temporary-field-3.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/alternative-classes-with-different-interfaces-1.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/alternative-classes-with-different-interfaces-2.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/parameterize-method-before.png)
**解决**

建立单一函数，以参数表达哪些不同的值。

![](http://dunwu.test.upcdn.net/cs/design/refactor/parameterize-method-after.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/refused-bequest-1.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/refused-bequest-2.png)

### 收益

- 提高代码的清晰度和组织性。

![](http://dunwu.test.upcdn.net/cs/design/refactor/refused-bequest-3.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/replace-inheritance-with-delegation-before.png)
...
![](http://dunwu.test.upcdn.net/cs/design/refactor/replace-inheritance-with-delegation-after.png)
