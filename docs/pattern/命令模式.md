...
- [1. 意图](#1-意图)
  - [1.1. 命令模式的交互](#11-命令模式的交互)
  - [1.2. 命令模式的要点](#12-命令模式的要点)
- [2. 适用场景](#2-适用场景)
- [3. 结构](#3-结构)
  - [3.1. 结构说明](#31-结构说明)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210519150619.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210519151632.png)
