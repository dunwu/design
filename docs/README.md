...
- **分布式关键技术**
  ...
  - 选主
  - **流量调度**
    - [负载均衡](02.分布式/03.分布式关键技术/01.流量调度/01.负载均衡.md) - 关键词：`轮询`、`随机`、`最少连接`、`源地址哈希`、`一致性哈希`、`虚拟 hash 槽`
    - [流量控制](02.分布式/03.分布式关键技术/01.流量调度/02.流量控制.md) - 关键词：`限流`、`熔断`、`降级`、`计数器法`、`时间窗口法`、`令牌桶法`、`漏桶法`
    - 网关
    - [分布式会话](02.分布式/03.分布式关键技术/01.流量调度/03.分布式会话.md) - 关键词：`粘性 Session`、`Session 复制共享`、`基于缓存的 session 共享`
  - **数据调度**
